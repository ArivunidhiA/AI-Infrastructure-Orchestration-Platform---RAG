...
const buttonVariants = cva(
    "relative group border text-foreground mx-auto text-center rounded-full",
    {
        variants: {
            variant: {
                default: "bg-white/5 hover:bg-white/0 border-white/20 text-white",
                solid: "bg-white hover:bg-white/90 text-black border-transparent hover:border-foreground/50 transition-all duration-200",
                ghost: "border-transparent bg-transparent hover:border-white/30 hover:bg-white/10 text-white",
            },
            size: {
                default: "px-7 py-1.5 ",
                sm: "px-4 py-0.5 ",
